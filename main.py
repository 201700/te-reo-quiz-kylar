#score funtion
score = 0
#asking what your names is, greeting you with your name, then explaing that this is a te reo quiz and explaing what you'll do while doing it. the time sleep and import time are there to give the reader enough time to read it before starting the quiz.
import time
...
#these are the question funtions and the final score  funtions. the question funtions make you go to the next question when you answer one.then the final score funtion connects with the rest to calculate your final score and print it onto the console.
question1()
